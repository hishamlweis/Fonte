...
public class BrownWrapsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Brown Wraps");
        imageView.setImageResource(R.drawable.tortillabrown);
        productPrice.setText("7 SAR");

        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BrownWrapsActivity.this, ShoppingActivity.class);
        ...
        minusQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 7;
                if (quantity == 0) {
                    Toast.makeText(BrownWrapsActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
