...
public class MiniMilkBreadActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Mini Milk Bread");
        imageView.setImageResource(R.drawable.minimilkbread);
        productPrice.setText("3 SAR");

        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MiniMilkBreadActivity.this, ShoppingActivity.class);
        ...
        minusQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 3;
                if (quantity == 0) {
                    Toast.makeText(MiniMilkBreadActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
