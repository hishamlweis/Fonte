...
public class SesameBurgerBunActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Sesame Burger Bun");
        imageView.setImageResource(R.drawable.sesameburgerbunjumbo);
        productPrice.setText("4 SAR");

        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SesameBurgerBunActivity.this, ShoppingActivity.class);
        ...
        minusQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 4;
                if (quantity == 0) {
                    Toast.makeText(SesameBurgerBunActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
