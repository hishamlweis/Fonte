...
public class SubSandwichSesameActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Sub Sandwich Sesame");
        imageView.setImageResource(R.drawable.subsandwichsesamejumbo);
        productPrice.setText("3 SAR");

        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SubSandwichSesameActivity.this, ShoppingActivity.class);
        ...
        minusQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 3;
                if (quantity == 0) {
                    Toast.makeText(SubSandwichSesameActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
