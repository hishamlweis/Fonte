...
public class TomatoWrapsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Tomato Wraps");
        imageView.setImageResource(R.drawable.tortillatomato);
        productPrice.setText("7 SAR");

        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TomatoWrapsActivity.this, ShoppingActivity.class);
        ...
        minusQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 7;
                if (quantity == 0) {
                    Toast.makeText(TomatoWrapsActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
